...
Currently this is actually rather plain, but this is the tab where
a user would adjust settings related to their account on whatever
protocol they're using.

It also provides the right click handling on the actual profile picture
in the spaces navigation.


**** Imports


#+begin_src clojurescript :tangle ../../../../../src/paradise/ui/overlays/settings/profile.cljs
